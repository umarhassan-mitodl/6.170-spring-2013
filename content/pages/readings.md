...
Crockford, Douglas. *JavaScript: The Good Parts*. O'Reilly Media, 2008. ISBN: 9780596517748. \[Preview with {{% resource_link "501ffa4d-7a3e-4eac-90bb-70f80507010d" "Google Books" %}}\]

Fernandez, Obie. *The Rails 3 Way*. 2nd ed. Addison-Wesley Professional, 2010. ISBN: 9780321601667. \[Preview with {{% resource_link "fb288460-dc1d-4c2e-8ba3-825be2ec3ff4" "Google Books" %}}\]

Fulton, Hal. *The Ruby Way, Second Edition*. 2nd ed. Addison-Wesley Professional, 2006. ISBN: 9780672328848.

Stefanov, Stoyan. *JavaScript Patterns*. O'Reilly Media, 2010. ISBN: 9780596806750. \[Preview with {{% resource_link "094f65e5-edf7-4841-8b27-ddde7f3f130e" "Google Books" %}}\]
...
Dikstra, E. W. "{{% resource_link "f52b268e-4daf-4d86-ac90-6f9e807278c3" "On the Role of Scientific Thought" %}}." In *Selected Writings on Computing: A Personal Perspective*. Springer, 1982, pp. 60–6. ISBN: 9780387906522.

Fowler, Martin. "The Three Principal Layers." Chapter 1 in *Patterns of Enterprise Application Architecture*. Addison-Wesley Professional, 2002. ISBN: 9780321127426. \[Preview with {{% resource_link "a003c464-7569-4c27-8fec-4dabfe2be827" "Google Books" %}}\]
...
Parnas, David L. "{{% resource_link "1b33fc61-3a99-4c38-aea1-ed3f2b98d302" "Designing Software for Ease of Extension and Contraction" %}}." *IEEE Transactions on Software Engineering* 5, no. 2 (1979): 128–38.

Benson, Edward. "Resources and REST." Chapter 6 in *Art of Rails (Programmer to Programmer)*. Wrox, 2008. ISBN: 9780470189481. \[Preview with {{% resource_link "cf076002-0b26-459a-b0c0-0a438aca69a6" "Google Books" %}}\]
...
{{< tdclose >}}{{< tdopen >}}
Chen, Peter. "{{% resource_link "10914d11-87f8-4243-9a2c-ccf70af27f00" "The Entity-Relationship Model – Toward a Unified view of Data" %}}." *ACM Transactions on Database Systems* 1, no. 1 (1976): 9–36.
{{< tdclose >}}{{< trclose >}}{{< tropen >}}{{< tdopen >}}
...
{{< tdclose >}}{{< tdopen >}}
Ullman, Jeffrey D., and Jennifer Widom. "The Relational Data Model." Chapter 3 in *A First Course in Database Systems*. Prentice-Hall, 1997, pp. 85–90. ISBN: 9780138613372. \[Preview with {{% resource_link "f12d3f84-0b30-4ebd-b176-1a099634c6a4" "Google Books" %}}\]
{{< tdclose >}}{{< trclose >}}{{< tropen >}}{{< tdopen rowspan="2" >}}
4
{{< tdclose >}}{{< tdopen >}}
...
Alexander, Christopher. "Goodness of Fit." *Notes on the Synthesis of Form*. Harvard University Press, 1964, pp. 15–9. IBSN: 9780674627512. \[Preview with {{% resource_link "0b20a2ac-3fa0-4d53-b48c-359da774a8fe" "Google Books" %}}\]
...
{{< tdclose >}}{{< tdopen >}}
Hoare, C. A. R. {{% resource_link "a95f8754-eb89-4719-b5bb-347169e203c9" "\"The Emperor's Old Clothes.\" (PDF)" %}} *Communications of the ACM* 24, no. 2 (1981): 75–83.
{{< tdclose >}}{{< trclose >}}{{< tropen >}}{{< tdopen >}}
...
Ungar, David, and Randall Smith. "{{% resource_link "3005e3f2-48ec-4e4b-b1df-b796276a1bdf" "SELF: The Power of Simplicity" %}}." *LISP and Symbolic Computation* 4, no. 3 (1991): 187–205.
...
Porter, Joshua. "{{% resource_link "f0a42cb8-5164-4304-be85-187922b44a1c" "Principles of User Interface Design" %}}." *Bokardo*.
...
Czaplicki, Evan. "{{% resource_link "9e5f6975-d912-474c-8039-66632db2db01" "Escape from Callback Hell" %}}." *Elm*.
...
Zalewski, Michal. "Security in the World of Web Applications." Chapter 1 in *Tangled Web: A Guide to Securing Modern Web Applications*. No Starch Press, 2011, pp. 14–8. ISBN: 9781593273880. \[Preview with {{% resource_link "263b3c6f-75ca-4c84-af82-0a9f19337b58" "Google Books" %}}\]

Ranum, Marcus. {{% resource_link "e06e6952-58cc-4465-b521-d364f6e671fb" "\"Six dumbest Ideas in Computer Security.\" (PDF)" %}} *Ranum,* September 1, 2005.
...
Dijkstra, Edsger. "{{% resource_link "a1a08827-b154-4812-9ed3-6169123388d0" "The pragmatic engineer versus the scientific designer" %}}." 1978.
...
Thimbleby, Harold. "{{% resource_link "f97bf7b4-b45b-4b74-b8f5-7fa32e172fb6" "Ignorance of Interaction Programming is Killing People" %}}." *Interactions* 15, no. 5 (2008): 52–7.

———. "Saving Lives by Design." September 1, 2011. Youtube. {{% resource_link "40f5191a-3078-4251-926e-7219995bf4e2" "www.youtube.com/watch?v=glwtlH0oYc0" %}}
